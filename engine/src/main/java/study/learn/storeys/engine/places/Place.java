 ...
 */
package study.learn.storeys.engine.places;
...
public class Place extends Interactlet {

    String description; // "You are in.. {description}"
    Map<String, Place> nextPlaces;
    Set<Thing> things;
    Map<String, Object> variables; // lit? power?
    // TODO actions
